locals {
  ...
  input = {
    ...
    cluster     = var.cluster == null ? var.context.cluster : var.cluster
    stage       = var.stage == null ? var.context.stage : var.stage
    description = var.description == null ? var.context.description : var.description
  ...
  string_label_names = ["namespace", "tenant", "cluster", "stage", "description"]
  ...
  cluster     = local.formatted_labels["cluster"]
  stage       = local.formatted_labels["stage"]
  description = local.formatted_labels["description"]
